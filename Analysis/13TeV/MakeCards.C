...
{ 
    ...
    TFile* HistFile = TFile::Open(Form("~/cms26/MJ_Out/HistFiles/YieldsBook/Hist_%s.root", Region));
    ...
    // Print out on file  
    // -------------------------------------
    fout.open(Form("~/cms26/MJ_Out/Output/YieldsBook/Cards/%s_%s.dat", Region, lepflavname.Data()));
